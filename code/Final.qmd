...
library(effsize) # read in effsize 
...
welch_test <- t.test(screen_time_min ~ day_type, # store t test result between screen_time_min and day_type in new object welch_test 
                     ...
                     VAR = FALSE) # variance are not equal: Welch's t test 
...
cohen.d(screen_time_min ~ day_type,  # calculates Cohen's d for screen_time_min across the groups in day_type
        data = mydata_clean, # use mydata_clean data frame 
